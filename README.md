...
![Initial Repository](photos/Screenshot%202026-06-23%20162829.png)
*This screenshot shows the initial empty repository on GitHub (`MariaDariaTompea/PrologDetective`) before the full game suite was pushed.*

---

### 2. Investigating Rooms & Discovering Clues
...
### 3. Discovered Physical Evidence List
...
### 6. The Prolog Reasoner (Ask Deductor)
...
### 7. Raw Prolog Query Console Output
